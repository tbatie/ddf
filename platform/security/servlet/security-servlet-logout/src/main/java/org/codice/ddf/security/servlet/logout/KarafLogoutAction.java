...
public class KarafLogoutAction implements ActionProvider {
    ...
    private static final String DESCRIPTION = "Logging out of the karaf realm will also log you out of the ldap realm. Accounts signed into external sources will remain logged in.";
