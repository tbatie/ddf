...
public class AdminConfigPolicyTest {
    ...
    public void testInvalidPolicyConfigs() {
        ...
        // TODO: tbatie - 6/2/16 - Write invalid policy config
    ...
    public void testRemoveSomePermissions() {
        ...
        List<KeyValuePermission> matchOneServicePermissions = getMatchOnePermissions(
                AdminConfigPolicy.VIEW_SERVICE_ACTION);
    ...
    @Test
    public void testRemoveUnknownAttri() {

    }

    @Test
    public void testUnknownFeatureAndService() {
