...
import org.codice.ddf.features.test.features.NotificationsFeatureFile;
...
public class ITNotificationsFeature {
  ...
  private static final String NOTIFICATIONS_FEATURE_FILE =
      ITNotificationsFeature.class.getResource(File.separator + "features.xml").getPath();
  ...
  public Option[] examConfiguration() {
    return options(
        ...
        addFeaturesToFeatureRepo(NotificationsFeatureFile.featureFile(NOTIFICATIONS_FEATURE_FILE)),
  ...
  @Test
  public void installNotificationsCoreApi()
      throws FeatureUninstallException, FeatureInstallException {
    featuresService.installAndUninstallFeature(NotificationsFeatureFile.notificationsCoreApi());
  }

  @Test
  public void installNotificationsCore() throws FeatureUninstallException, FeatureInstallException {
    featuresService.installAndUninstallFeature(NotificationsFeatureFile.notificationsCore());
  }

  @Test
  public void installNotificationsCoreCommands()
      throws FeatureUninstallException, FeatureInstallException {
    featuresService.installAndUninstallFeature(NotificationsFeatureFile.notificationsCommands());
  }
}
