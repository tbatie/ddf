...
import org.codice.ddf.features.test.features.AppsFeatureFile;
...
public class ITAppsFeatureFile {
  ...
  private static final String APPS_FEATURE_FILE =
      ITAppsFeatureFile.class.getResource(File.separator + "features.xml").getPath();
  ...
  public Option[] examConfiguration() {
    return options(
        ...
        defaultVmOptions(),
        defaultPortsOptions(),
        addFeaturesToFeatureRepo(AppsFeatureFile.featureFile(APPS_FEATURE_FILE)),
  ...
  @Test
  public void installPlatformApp() throws FeatureUninstallException, FeatureInstallException {
    featuresService.installAndUninstallFeature(AppsFeatureFile.platformApp());
  }

  @Test
  public void installSecurityServicesApp()
      throws FeatureUninstallException, FeatureInstallException {
    featuresService.installAndUninstallFeature(AppsFeatureFile.securityServicesApp());
  }
}
