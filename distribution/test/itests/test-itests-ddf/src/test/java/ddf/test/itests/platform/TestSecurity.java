...
public class TestSecurity extends AbstractIntegrationTest {
    ...
    // TODO: tbatie - 6/14/16 - FIX VERSION NUMBER
    protected static final String SDK_FEATURE_FILE_PATH =
            "mvn:ddf.distribution/sdk-app/2.10.0-SNAPSHOT/xml/features";
    ...
    public static String addSdkAppJolokiaReq =
    ...
    public void beforeTest() throws Exception {
        try {
            ...
            Configuration config = configAdmin.getConfiguration(
                    "org.codice.ddf.admin.config.policy.AdminConfigPolicy");
            // TODO: tbatie - 6/14/16 - FIX THE VERSION NUMBER
            config.setBundleLocation("mvn:ddf.admin.core/admin-core-configpolicy/2.10.0-SNAPSHOT");
    ...
    public void testAdminConfigPolicyGetServices() {
        ...
        //Verify a permitted user can see the services
