...
public class TestZipValidator {
    ...
    private static final String BAD_CERT_ZIP_PATH = TestZipCompression.class.getClassLoader().getResource(
            BAD_CERT_ZIP)
            .getPath();

    private static final String ALTERED_ZIP = "addedFile.zip";

    private static final String ALTERED_ZIP_PATH = TestZipCompression.class.getClassLoader().getResource(
            ALTERED_ZIP)
            .getPath();

    private static final String MODIFIED_MANIFEST_ZIP = "addedFile.zip";

    private static final String MODIFIED_MANIFEST_ZIP_PATH = TestZipCompression.class.getClassLoader().getResource(
            MODIFIED_MANIFEST_ZIP)
            .getPath();
